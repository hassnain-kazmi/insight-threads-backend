...
async def get_insights_endpoint(
    ...
    try:
        ...
        insight_responses = [InsightResponse.model_validate(insight) for insight in insights]
...
@router.get("/{insight_id}", status_code=status.HTTP_200_OK, response_model=InsightResponse)
