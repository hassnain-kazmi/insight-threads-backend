...
class DocumentSentimentResponse(BaseModel):
    ...
    distilbert_score: float | None = Field(None, description="DistilBERT sentiment score")
...
class ClusterMembershipResponse(BaseModel):
    ...
    membership_strength: float | None = Field(None, description="Membership strength score")
...
class DocumentDetailResponse(BaseModel):
    ...
    created_at: datetime = Field(..., description="Document creation timestamp")
    updated_at: datetime = Field(..., description="Document last update timestamp")
    sentiment: DocumentSentimentResponse | None = Field(None, description="Document sentiment analysis")
    cluster_memberships: list[ClusterMembershipResponse] = Field(default_factory=list, description="Cluster memberships")
