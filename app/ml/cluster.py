...
def compute_hdbscan_clusters(
    ...
    try:
        ...
        if len(embeddings_array.shape) != 2:
            raise ValueError(f"Expected 2D array of embeddings, got shape {embeddings_array.shape}")
...
def extract_keywords(
    ...
    **kwargs: Any,
    ...
    if method == "tfidf":
        ...
        raise ValueError(f"Unknown keyword extraction method: {method}. Use 'tfidf' or 'keybert'")
