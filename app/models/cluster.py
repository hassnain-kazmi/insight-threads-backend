...
class Cluster(Base):
    ...
    keywords = relationship(
        "Keyword", back_populates="cluster", cascade="all, delete-orphan"
    )
    timeseries = relationship(
        "TimeseriesSummary", back_populates="cluster", cascade="all, delete-orphan"
    )
    anomalies = relationship(
        "Anomaly", back_populates="cluster", cascade="all, delete-orphan"
    )
    insights = relationship(
        "Insight", back_populates="cluster", cascade="all, delete-orphan"
    )
