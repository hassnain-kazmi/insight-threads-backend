...
_use_supabase = hasattr(settings, "SUPABASE_SERVICE_KEY") and settings.SUPABASE_SERVICE_KEY
    ...
    if _use_supabase and _supabase_client:
        try:
            ...
            if "409" in error_str or "duplicate" in error_str:
                ...
                return storage_url
            logger.error(f"Failed to upload to Supabase: {e}, falling back to local storage")
