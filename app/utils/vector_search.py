...
def _build_vector_search_query(
    ...
    if similarity_threshold is not None:
        query_parts.append(f"AND (de.embedding <=> {vector_literal_quoted}::vector) <= :threshold")
...
def search_similar_embeddings_sync(
    ...
    try:
        id_sql_query = _build_vector_search_query(vector_literal, user_id, similarity_threshold)
