...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "ingest_event_id",
            sa.UUID(),
            sa.ForeignKey("ingest_events.id", ondelete="SET NULL"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "document_id", "model_name", name="uq_document_embeddings_document_model"
        ),
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "cluster_id", "summary_date", name="uq_timeseries_cluster_date"
        ),
    )
